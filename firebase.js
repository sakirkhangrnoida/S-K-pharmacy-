...
// 5. EmailJS - तेरे नए वाले डाल दिए
export const EMAILJS_PUBLIC_KEY = "z3cFw4MCTs6DKv2Cj"; // Account > API Keys से लेना
export const EMAILJS_SERVICE_ID = "service_u1c0277";
export const EMAILJS_TEMPLATE_ID = "template_e30f5vd"; // <-- नया वाला
